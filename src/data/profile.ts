	...
	experience: [
		{
			...
			highlights: {
				es: [
					'Dirige la operación ecommerce y growth digital de WU Nutrition (DTC Shopify) y Come Verde (CPG retail + marketplaces).',
					'Conecta storefront, CRO, paid media, CRM, analítica y documentación operativa en un solo sistema de decisión.',
					'Implementa componentes Shopify (PDP/PLP, landings, cart drawer, sticky ATC, trust) y producto conversacional conectado con datos comerciales de Shopify.',
					'Opera Growth OS y una capa de IA empresarial: scorecards, optimización de paid media, estrategia de marca con Claude, MCPs y aprobación humana.',
					'Para Come Verde, diferencia KPIs CPG (brand building, activaciones, rotación) de métricas DTC; publica playbooks sin mezclar ROAS de tienda física.',
					'Documenta procesos técnicos y operativos para mantenimiento, continuidad y escalabilidad del equipo.',
				],
				en: [
					'Leads ecommerce and digital growth operations for WU Nutrition (Shopify DTC) and Come Verde (CPG retail + marketplaces).',
					'Connects storefront, CRO, paid media, CRM, analytics, and operational documentation into one decision system.',
					'Implements Shopify components (PDP/PLP, landings, cart drawer, sticky ATC, trust) and a conversational product connected to Shopify commerce data.',
					'Runs Growth OS and an enterprise AI layer: scorecards, paid-media optimization, Claude brand strategy, MCPs, and human approval.',
					'For Come Verde, separates CPG KPIs (brand building, activations, velocity) from DTC metrics; ships playbooks without treating in-store ROAS as an ad-platform KPI.',
					'Documents technical and operational processes for maintenance, continuity, and team scalability.',
				],
			},
		},
		{
