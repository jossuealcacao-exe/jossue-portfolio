		...
		},
		{
			...
			highlights: {
				es: [
					...
					'Stack con Shopify CLI, React/TypeScript, GitHub, Railway/Cloudflare y AHP+ para pasar el trabajo entre asistentes sin perder contexto.',
				],
				en: [
					...
					'Stack with Shopify CLI, React/TypeScript, GitHub, Railway, Cloudflare, and AHP+ to move work between assistants without losing context.',
				],
			},
		},
		{
